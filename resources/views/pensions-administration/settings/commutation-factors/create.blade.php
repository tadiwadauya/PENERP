...
@section('title', 'Add Commutation Factor')

@section('page-heading', 'Add Commutation Factor')

@section('page-subheading')
Create a new age, month and gender based commutation factor
@endsection
...
<div class="card mb-3">
    <div class="card-body">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h4 class="header-title mb-1">Add Commutation Factor</h4>
                <p class="text-muted mb-0">Define the exact age, gender, factor and effective period.</p>
            </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('pensions-administration.settings.commutation-factors.store') }}">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="mb-3">
                        ...
                        <select name="age_months" class="form-select @error('age_months') is-invalid @enderror" required>
                            @for($month = 0; $month <= 11; $month++)
                                <option value="{{ $month }}" @selected((string) old('age_months', '0') === (string) $month)>{{ $month }} {{ \Illuminate\Support\Str::plural('month', $month) }}</option>
                            @endfor
                        </select>
