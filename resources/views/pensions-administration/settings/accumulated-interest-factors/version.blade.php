...
@section('title', 'New Accumulated Interest Factor Version')

@section('page-heading', 'New Accumulated Interest Factor Version')

@section('page-subheading')
Create a new effective-dated factor while retaining the current version for historical calculations
@endsection
    ...
    <div class="card-body">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="text-muted mb-0">{{ ucfirst($factor->gender) }} - Age {{ $factor->age_years }}</p>
            </div>
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('pensions-administration.settings.accumulated-interest-factors.version.store', $factor) }}">
            @csrf
