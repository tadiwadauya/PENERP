...
use App\Http\Controllers\PensionsAdministration\Updates\MembershipRegisterController;
use App\Http\Controllers\PensionsAdministration\Updates\EmployerMembershipReportController;
...
use App\Http\Controllers\PensionsAdministration\HistoricalContributions\HistoricalContributionImportController;
        ...
        Route::prefix('pensions-administration')
            ...
            ->group(function (): void {
                ...
                */
                ...
                Route::prefix('updates')
                    ...
                    ->group(function (): void {
                        ...
                        */
                        ...
                        Route::get('/', [UpdatesDashboardController::class, 'index'])
                            ->middleware('permission:updates.dashboard.view')
                            ->name('dashboard');
                        ...
                        |--------------------------------------------------------------------------
                        |
                        | Routes remain under Updates for now because the controllers and
                        | current development are located here.
                        |
                        | Access is NOT tied to Updates roles. Benefits and Payroll roles
                        | can later receive pensions.reports.* permissions.
                        |
                        */
                        ...
                        Route::get('reports/membership/data/legacy', [MembershipReportController::class, 'legacyData'])->middleware('permission:pensions.reports.membership.view')->name('reports.membership.legacy-data');
                        Route::get('reports/membership/data/quality', [MembershipReportController::class, 'dataQualityData'])->middleware('permission:pensions.reports.membership.view')->name('reports.membership.data-quality-data');

                        Route::get('reports/employer-membership', [EmployerMembershipReportController::class, 'index'])->middleware('permission:pensions.reports.employer-membership.view')->name('reports.employer-membership.index');
                        Route::get('reports/employer-membership/data', [EmployerMembershipReportController::class, 'data'])->middleware('permission:pensions.reports.employer-membership.view')->name('reports.employer-membership.data');
                        Route::get('reports/employer-membership/{employer}/members', [EmployerMembershipReportController::class, 'members'])->middleware('permission:pensions.reports.employer-membership.view')->name('reports.employer-membership.members');
                        Route::get('reports/employer-membership/{employer}/members/data', [EmployerMembershipReportController::class, 'membersData'])->middleware('permission:pensions.reports.employer-membership.view')->name('reports.employer-membership.members-data');
                        ...
                        */
                        ...
                        Route::get('members', [MembershipRegisterController::class, 'index'])->middleware('permission:updates.members.view')->name('members.index');
                        Route::get('members/data', [MembershipRegisterController::class, 'data'])->middleware('permission:updates.members.view')->name('members.data');
                ...
                | IMPORTANT:
                |
                | Historical migration is a System Administrator function.
                |
                | Both role AND permission are checked.
                |
                */

                Route::prefix('historical-contributions')
                    ->name('historical-contributions.')
                    ->middleware([
                        'role:system-administrator',
                        'permission:contributions.historical-imports.manage',
                    ])
                    ->group(function (): void {

                        Route::get('imports', [HistoricalContributionImportController::class, 'index'])->name('imports.index');
                        Route::get('imports/create', [HistoricalContributionImportController::class, 'create'])->name('imports.create');
                        Route::post('imports', [HistoricalContributionImportController::class, 'store'])->name('imports.store');
                        Route::get('imports/{batch}/status', [HistoricalContributionImportController::class, 'status'])->name('imports.status');

                        Route::get('imports/{batch}/review', [HistoricalContributionReviewController::class, 'index'])->name('review.index');
                        Route::get('imports/{batch}/review/data', [HistoricalContributionReviewController::class, 'data'])->name('review.data');
                        Route::post('imports/{batch}/review/rows/{row}/decision', [HistoricalContributionReviewController::class, 'decision'])->name('review.decision');
                        Route::post('imports/{batch}/review/approve-eligible', [HistoricalContributionReviewController::class, 'approveEligible'])->name('review.approve-eligible');
                        Route::post('imports/{batch}/review/approve-warnings', [HistoricalContributionReviewController::class, 'approveWarnings'])->name('review.approve-warnings');
                        Route::post('imports/{batch}/review/finalise', [HistoricalContributionReviewController::class, 'finalise'])->name('review.finalise');

                        Route::post('imports/{batch}/post', [HistoricalContributionPostingController::class, 'store'])->name('posting.store');
                        Route::get('imports/{batch}/posting-status', [HistoricalContributionPostingController::class, 'status'])->name('posting.status');

                        Route::delete('imports/{batch}', [HistoricalContributionImportController::class, 'destroy'])->name('imports.destroy');

                        /*
                        |--------------------------------------------------------------------------
                        | Keep Generic Batch Route Last
                        |--------------------------------------------------------------------------
                        */

                        Route::get('imports/{batch}', [HistoricalContributionImportController::class, 'show'])->name('imports.show');
                ...
                Route::prefix('contributions')
                    ...
                    ->group(function (): void {
                        ...
                        */
                        ...
                        Route::get('members/{member}/expected-contributions', [MemberContributionHistoryController::class, 'show'])->middleware('permission:contributions.monthly-imports.view')->name('members.expected-contributions');
